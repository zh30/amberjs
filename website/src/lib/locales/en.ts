...
export const en: TranslationSchema = {
  ...
  home: {
    ...
    latestArticle: {
      ...
      desc: "Zero-copy WebAssembly.Memory, bee bundle / compile (Preview), benchmark suite 2.0, and URL / fetch / ReadableStream RSI. Node Conformance 5.0 remains 55/55.",
      readTime: "4 min read",
      date: "2026-09-16",
      link: "/blog/v1.16.0",
    ...
    benchmarksSub:
      "Suite 2.0, 2026-09-16. Beejs vs Node.js v22.22.3 vs Bun 1.4.1. Lower time is better except Express (req/s).",
    benchmarksNote:
    ...
    benchmarks: [
      ...
      },
      {
        ...
        nodeValue: "27.53 ms",
        nodeOps: "1.49x slower than Beejs",
    ...
    telemetryNote:
      "Beejs vs Node v22.22.3 vs Bun 1.4.1. Conformance is tests/conformance/ (55 fixtures).",
    telemetry: [
      {
    ...
    features: [
      ...
      },
      {
        ...
        desc: "bee test with describe / test / expect. --parallel is rejected: isolates are not shared across threads.",
      },
      {
  ...
  docs: {
    ...
    subtitle:
      "Manual for Beejs v1.16.0 — runtime, CLI, sandbox, and agent APIs.",
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: "Dynamic Package Runner (bee x / dlx)",
            badge: "CLI",
          },
          {
    ...
    sections: {
      introduction: {
        ...
        body: [
          "Beejs v1.16.0 is a Rust + V8 JavaScript/TypeScript runtime in one binary: bee. Node Conformance 5.0 is 55/55 fixtures — that is not drop-in Node compatibility.",
      ...
      "api-reference": {
        ...
        subtitle:
          "Comprehensive specification of native BeeJS subsystems (bee:*), Node.js core, and Web APIs.",
        body: [
