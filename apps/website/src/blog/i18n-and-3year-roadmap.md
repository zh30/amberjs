...
excerpt: "Amber website now features complete English and Chinese i18n along with our 2026-2029 3-year technical vision for AI-Native & Edge computing."
date: "2026-07-27"
...
We are excited to share two major milestone updates for the Amber runtime project today: full-site internationalization (i18n) across our entire web surface, and the official release of the **Amber 3-Year Technical Roadmap (2026 – 2029)**.
...
Amber is evolving from a lightweight JavaScript/TypeScript runtime into the **next-generation sovereign execution engine for AI-Native & Edge workloads**.
