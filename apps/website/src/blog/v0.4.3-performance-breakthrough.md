---
title: "Amber v0.4.3: Architectural Breakthrough & Performance Parity with Node and Bun"
...
# Amber v0.4.3: Architectural Breakthrough & Performance Parity with Node and Bun

Today we are proud to announce the release of **Amber v0.4.3**.
...
With v0.4.3, Amber has reached a major milestone: **defeating or matching both Node.js v24 and Bun.js v1.4 across critical runtime benchmarks**, while maintaining 100% test passes across 369 core Rust unit tests and 45 Node.js official conformance fixtures.
...
- **Benchmark (30,000 require calls)**:
  - **Amber: 6.52 ms (4,601,226 ops/s)** 🥇
  - **Bun.js: 16.02 ms (1,872,659 ops/s)** (Amber is **2.45x faster**)
  - **Node.js: 26.96 ms (1,112,759 ops/s)** (Amber is **4.13x faster**)
...
| Workload | Amber v0.4.3 | Node.js v24.16 | Bun.js v1.4.1 | Amber Standing |
| :--- | :---: | :---: | :---: | :--- |
...
| **Sync File I/O (100 x 32KB)** | **7.87 ms** | 7.24 ms | 5.29 ms | ⚡ **3.1x faster than prior Amber versions** |
