...
excerpt: "How Amber v0.1 tightened CLI output, release checks, and documentation before publishing."
date: "2026-05-25"
...
The v0.1 release work focuses on turning the Amber runtime from an active development repository into something users can install and evaluate without internal noise.
...
The website and README now describe Amber v0.1 as a Rust + V8 JavaScript/TypeScript runtime with a focused CLI and compatibility layer. Historical stage reports remain in the repository, but release-facing pages avoid unverified performance numbers.
