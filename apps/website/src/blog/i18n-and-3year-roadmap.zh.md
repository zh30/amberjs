...
excerpt: "Amber 官网现已全面支持中英文双语体验，并正式公布 2026-2029 年面向 AI-Native 与边缘计算的 3 年技术拓扑路线图。"
date: "2026-07-27"
author: "Amber 核心团队"
readTime: "3 分钟阅读"
tag: "版本发布"
...
今天我们非常高兴向社区宣布 Amber 项目的两项重要更新：官方网站全站多语言（i18n）功能的完整上线，以及 **Amber 未来 3 年技术拓扑路线图（2026 – 2029）** 的正式公布。

## 🌐 纯正的开发者多语言体验

Amber 官方网站（[bee.zhanghe.dev](https://amberjs.com)）现已提供自然顺畅的中英文双语无缝切换：
...
Amber 将超越传统的单进程 JS 运行时，致力于成为面向 **AI-Native、边缘计算（Edge-Native）与自主 Agent 架构** 的下一代主权级计算引擎。
