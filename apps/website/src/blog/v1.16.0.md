...
v1.16.0 is a runtime release, not a marketing reset. The binary is still `bee`. The capability map is still [Current Scope](https://github.com/zh30/amberjs/blob/main/docs/CURRENT_SCOPE.md). Node.js Conformance 5.0 is still **55/55**.
