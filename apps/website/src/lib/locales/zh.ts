...
export const zh: TranslationSchema = {
  ...
  home: {
    ...
    latestArticle: {
      ...
      desc: "零拷贝 WebAssembly.Memory、amber bundle / compile（Preview）、基准套件 2.0，以及 URL / fetch / ReadableStream RSI。Node Conformance 5.0 仍是 55/55。",
      readTime: "4 分钟阅读",
      date: "2026-09-16",
      link: "/blog/v1.16.0",
      action: "阅读全文",
    ...
    benchmarksSub:
      "套件 2.0，2026-09-16。Amber vs Node.js v22.22.3 vs Bun 1.4.1。除 Express（req/s）外，时间越低越好。",
    benchmarksNote:
    ...
    telemetryNote:
      "Amber vs Node v22.22.3 vs Bun 1.4.1。符合度是 tests/conformance/（55 个 fixtures）。",
    telemetry: [
      {
    ...
    systems: [
      ...
      },
      {
        ...
        desc: "生产级 Bundler 2.0 模块打包与无需依赖的单二进制应用编译器 (amber compile)。",
      },
      {
  ...
  docs: {
    title: "运行时手册",
    subtitle: "Amber v1.16.0 手册 — 运行时、CLI、沙箱与 Agent API。",
    backToHome: "返回首页",
    ...
    sections: {
      ...
      "jit-optimization": {
        ...
        body: [
          "当 .ts 或 .tsx 文件传给 amber run 时，CLI 会走 oxc（TypeScript 6.0 语法，仅转译）。类型会被擦除。using 和 Stage 3 装饰器会降级到 ES2022，以适应当前 V8。TSX 输出 classic React.createElement。TypeScript 7.0 没有新语法。",
        ],
        list: [
