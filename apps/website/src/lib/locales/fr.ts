...
export const fr: TranslationSchema = {
  ...
  playground: {
    ...
    running: "En cours",
    language: "Langage",
    note: "S’exécute dans le navigateur, pas dans le binaire bee. TypeScript est vérifié par Monaco (l’éditeur de VS Code).",
    output: "Sortie",
  ...
  docs: {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          {
            id: "embedded-db",
            label: "Base de données & Vecteurs (bee:db & bee:vector)",
            badge: "DB",
          },
          {
            id: "standard-library",
            label: "Bibliothèque standard (bee:std)",
            badge: "Std",
          },
          {
          ...
          },
          {
            ...
            label: "Déploiement & Conteneurs (bee deploy)",
            badge: "Deploy",
          },
          {
            id: "ide-extension",
      ...
      },
      {
        ...
        items: [
          ...
          {
            id: "agent-replay",
            label: "Moteur de Rejeu Déterministe (bee:replay)",
            badge: "v1.6",
          },
          {
            id: "model-weights",
            label: "Chargeur de Poids GGUF & SafeTensors (bee:weights)",
            badge: "v1.6",
          },
          {
            id: "capability-security",
            label: "Sécurité Basée sur les Capacités (bee:security)",
            badge: "v1.6",
          },
          {
            id: "kv-store",
            label: "KV Persistant & État Durable (bee:kv)",
            badge: "v1.7",
          },
          {
            id: "tool-synthesis",
            label: "Auto-synthèse d’outils & OpenAPI (bee:tools)",
            badge: "v1.7",
          },
          {
            id: "hardened-sandbox",
            label: "Bac à sable Renforcé & Journaux d’Audit (bee:sandbox)",
            badge: "v1.7",
          },
          {
            id: "agent-bus",
            label: "Bus de Messages & PubSub d’Agents (bee:bus)",
            badge: "v1.8",
          },
          {
            id: "streaming-grammar",
            label: "Flux Structuré & Grammaires (bee:grammar)",
            badge: "v1.8",
          },
          {
            id: "agent-checkpoint",
            label: "Points de Contrôle & Restauration (bee:checkpoint)",
            badge: "v1.8",
          },
          {
            id: "mcp-protocol",
          ...
          {
            id: "ffi-native",
            label: "FFI Natif C ABI (bee:ffi)",
            badge: "v1.4",
          },
          {
            id: "wasm-interop",
            label: "Pont Mémoire Partagée Wasm 2.0 (bee:wasm)",
            badge: "v1.5",
          },
          {
            id: "slm-inference",
            label: "Edge SLM & Décodage JSON (bee:ai)",
            badge: "v1.4",
          },
          {
            id: "framework-compat",
    ...
    sections: {
      introduction: {
        ...
        body: [
          "Amber v1.16.0 est un runtime JavaScript/TypeScript en Rust + V8, un binaire : bee. Node Conformance 5.0 = 55/55 fixtures — ce n’est pas une compatibilité Node drop-in.",
      ...
      "server-mode": {
        ...
        body: [
          'bee serve démarre un écouteur tiny_http et retourne un JSON fixe {"ok":true}. Il n’exécute pas de scripts utilisateur. Pour un serveur applicatif, utilisez http.createServer et amber run.',
        ],
