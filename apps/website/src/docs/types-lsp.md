...
For smooth auto-completion, parameter hints, and type safety in modern IDEs (VS Code, Cursor, WebStorm), Amber includes full official TypeScript type definitions (`types/beejs.d.ts`).
